...
<div class="row" style="height: 830px">
	...
	<div class="col-md-6" style="color: white">
		...
		<p
			style="text-align: left; color: white; font-size: 1.5rem; background: #ff523b">Our
			product range has also expanded to include an award winning seed
			range, young plants, bulbs, seed potatoes, onions and garlic sets,
			soft fruit and fruit trees as well as an extensive range of gardening
			supplies. All have been carefully selected through stringent testing
			and trials to make gardening a pleasure and a success for our
			customers. In addition, we also offer a wonderful range of Christmas
			gifts sent with a personalised card to both the gardeners and non
			gardeners in your life!</p>
		<a class="btn btn-info" style="font-size: 24px;" href="products.jsp">view
			our products</a>
	</div>
</div>

<div class="col-md-12"
	style="background-color: #2F2828; padding-top: 50px">
	<div class="row">
